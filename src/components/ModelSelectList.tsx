...
/** The "Select model" section shown in the Duplicate-plan dialog. When the plan is already
 * on the latest model there's nothing to choose between, so it collapses to a plain
 * statement instead of a redundant radio choice. */
export function ModelSelectList({ currentModelDate, selectedModelId, onSelect }: Props) {
